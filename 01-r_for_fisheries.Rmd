...
## R
To install R, go to the [R webpage](https://cran.r-project.org/) and follow the link to your operating system of choice (Linux, Max OS X, Windows). Then, click on the most recent `.pkg` file and follow the instructions to complete the installation process. 
